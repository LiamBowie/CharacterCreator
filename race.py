class Race: 
    def __init__(self, race_name: str, ability_score_increase: dict, size: str, speed:int, 
                 lifespan:str, languages: list, resistances: list = [], darkvision: bool = False, 
                 weapon_proficiency: list = [], armour_training: list = [], tool_proficiency: list = [], 
                 spells: list = [], additional_traits: dict = []):
        self.name = race_name
