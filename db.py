...
races = {
    ...
    'forest gnome': Race(
        ...
        size='small',
        speed=25,
        lifespan='Gnomes mature at the same rate humans do, and most are expected to settle down into an adult life by around age 40. They can live 350 to almost 500 years.',
    ...
    'half-orc': Race(
        race_name='Half-Orc',
        ability_score_increase={'str': 2, 'con': 1},
        size='medium',
        speed=30,
    ...
    'human': Race(
        race_name='Human',
        ability_score_increase={'str': 1, 'dex': 1, 'con': 1, 'wis': 1, 'int': 1, 'cha': 1},
        size='medium',
        speed=30,
        lifespan='Humans reach adulthood in their late teens and live less than a century.',
        languages=['common', 'one extra language of your choice']
    ),
    # TODO: Choose two ability scores
    'human variant': Race(
        race_name='Human Variant',
